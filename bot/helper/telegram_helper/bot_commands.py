...
class _BotCommands:
    def __init__(self):
        ...
        self.QbLeechCommand = f'torrent_leech{CMD_INDEX}'
        self.QbUnzipLeechCommand = f'extract_torrent_leech{CMD_INDEX}'
        self.QbZipLeechCommand = f'qb_zip_leech{CMD_INDEX}'
        self.LeechWatchCommand = f'youtube_leech{CMD_INDEX}'
